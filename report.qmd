...
One step was to filter for a single year instead of working with data over time. We chose the year 2001, because of the other variables, location.gdp was of interest, and 2001 is the most recent year for which there is data on GDP across the world (there is no GDP data for 2014). The variable wealth was also renamed to just wealth.
...
First, we split the data into two sets depending on inheritance.
...
linear_reg() |>
  set_engine("lm") |>
  fit(wealth ~ location.gdp, data = billion2001) |>
  tidy()
...
billion2001 |>
  ...
  labs(title = "Relationship between Location GDP and Wealth for Billionaires",
       x = "Location GDP",
...
yes_inherited |>
  ...
  geom_point() +
  geom_smooth(method = "lm", se = F)  +
  labs(title = "Relationship between Country GDP and Wealth for Inherited Billionaires",
       x = "Location GDP",
       y = "Wealth (in billions of dollars)") +
  theme(text = element_text(size = 10))
...
not_inherited |>
  ...
  geom_point() +
  geom_smooth(method = "lm", se = F)  +
  labs(title = "Relationship between Country GDP and Wealth for Non-inherited Billionaires",
       x = "Location GDP",
       y = "Wealth (in billions of dollars)")  +
  theme(text = element_text(size = 10))
```
...
billion2001 |>
  ggplot(aes(x = industry, y = wealth)) +
  geom_point() +
  geom_smooth(method = "lm", se = F)  +
  labs(title = "Relationship between Industry Type and Wealth for Billionaires",
       x = "Industry Type",
       y = "Wealth (in billions of dollars)") +
...
yes_inherited |>
  ...
  geom_point() +
  geom_smooth(method = "lm", se = F)  +
  labs(title = "Relationship between Industry Type and Wealth for Inherited Billionaires",
       x = "Industry Type",
       y = "Wealth (in billions of dollars)") +
  theme(text = element_text(size = 8))
...
not_inherited |>
  ...
  geom_point() +
  geom_smooth(method = "lm", se = F)  +
  labs(title = "Relationship between Industry Type and Wealth for Non-inherited Billionaires",
       x = "Industry Type",
       y = "Wealth (in billions of dollars)") +
...
linear_reg() |>
    set_engine("lm") |>
    fit(wealth ~ age, data = billion2001) |>
  tidy()
...
billion2001 |>
    ...
    geom_point() +
    geom_smooth(method = "lm", se = F) +
  labs(title = "Relationship between Age and Wealth for Billionaires",
       x = "Age (years)",
       y = "Wealth (in billions of dollars)") +
  theme(text = element_text(size = 10))
...
linear_reg() |>
 ...
 yes_inherited |>
    ...
    geom_point() +
    geom_smooth(method = "lm", se = F) +
  labs(title = "Relationship between Age and Wealth for Inherited Billionaires",
       x = "Age (years)",
       y = "Wealth (in billions of dollars)") +
  theme(text = element_text(size = 10))
...
not_inherited |>
  ...
  geom_point() +
  geom_smooth(method = "lm", se = F) +
  labs(title = "Relationship between Age and Wealth for Non-inherited Billionaires",
       x = "Age (years)",
       y = "Wealth (in billions of dollars)") +
  theme(text = element_text(size = 8))
```
...
#calculation for proportion of tech industry billionaires per group
prop_tech_yi <- yes_inherited |>
  group_by(industry) |>
  filter(industry == "Technology")|>
  summarize(prop_tech = n()/nrow(yes_inherited))|>
  select(prop_tech)|>
  as.numeric()

prop_tech_ni <- not_inherited |>
 group_by(industry) |>
  filter(industry == "Technology")|>
  summarize(prop_tech = n()/nrow(not_inherited))|>
  select(prop_tech)|>
  as.numeric()
