...
-   Identify the types of variables in your research question. Categorical? Quantitative?
    ...
    The variables that we would measure to help explain the research question are quantatative and categorical. To measure inheritance, the data set has a categorical variable that measures if the wealth is inherited and how it is inherited if it is. To measure wealth of a country where the billionaire lives, we can measure the GDP of the country, a quantatative variable. To measure wealth, we can measure billionare rank compared to the rest of the billionaires and their worth in billions which are both quantative.
...
-   Provide a one paragraph summary about the article.
    ...
    The article discusses the rise of billionaires in several major countries and regions in the world, providing historical, social, and political context.
