...
-   A description of the research topic along with a concise statement of your hypotheses on this topic.
    ...
    -   Today expected income is among the most salient deciding factors when choosing a higher education path. The risk to reward ratio is often calculated between time committed in education to subsequent income. The two conflicting schools of thought are typically between maximizing education (pursuing a doctorate) and maximizing time in industry (forgoing a doctorate and committing to industry after University). We hope to address these concerns while factoring in other possibly confounding variables. We hypothesize that graduates with doctorates will on average have a higher income than those with a bachelors in business who are currently in industry.
